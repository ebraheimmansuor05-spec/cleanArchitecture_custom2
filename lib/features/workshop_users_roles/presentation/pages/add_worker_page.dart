  ...
  Future<void> _createWorker() async {
    ...
    if (_selectedRole == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('يرجى اختيار دور للعامل'),
        ),
      );
      return;
    }
    ...
    result.fold(
      ...
      (success) {
        setState(() {
          _createdWorkerLoginId = success.workerLoginId;
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '🆔 Worker Login ID: '
                    '${_createdWorkerLoginId ?? 'غير متاح'}',
      ...
      body: BlocBuilder<RoleCubit, RoleState>(
        builder: (context, state) {
          ...
          if (state is! RoleLoaded) {
            return const Center(
              child: Text('لا توجد أدوار متاحة'),
            );
          }
